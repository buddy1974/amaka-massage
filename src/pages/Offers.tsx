...
const offers = [
  { icon: Sparkles, title: "New Client Offer", text: "10% discount on your first visit." },
  { icon: Tag, title: "3 Sessions Package", text: "Save 5 € when you book 3 sessions." },
  { icon: Tag, title: "5 Sessions Package", text: "Save 10 € when you book 5 sessions." },
  { icon: Gift, title: "Gift Voucher", text: "Available for all services. The perfect gift." },
];
  ...
  <Layout>
    ...
    <section className="container py-16">
      ...
      <div className="mt-10 grid md:grid-cols-2 bg-card rounded-2xl overflow-hidden shadow-soft">
        <img src={couple} alt="Couple massage" loading="lazy" width={800} height={600}
          className="h-64 md:h-full w-full object-cover" />
        <div className="p-10">
          <Users className="h-8 w-8 text-primary" />
          <h3 className="font-serif text-3xl text-primary-deep mt-3">Couple Massage</h3>
          <p className="text-muted-foreground mt-2">Share a relaxing experience side by side.</p>
          ...
          <Link to="/contact">
            <Button className="mt-6 gradient-purple text-primary-foreground hover:opacity-90">
              <Heart className="mr-2 h-4 w-4" /> Book Couple Massage
            </Button>
          </Link>
        </div>
      </div>
