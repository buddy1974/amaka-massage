  ...
  <Layout>
    <section className="gradient-hero py-16">
      <div className="container text-center">
        ...
        <h1 className="font-serif text-5xl text-primary-deep">AMAKA'S CITY</h1>
        <p className="font-script text-2xl text-primary mt-2">Ihr Wohlbefinden steht an erster Stelle.</p>
        <p className="text-muted-foreground mt-2">Traditionelle Massage und Wellness Spa Salon</p>
      </div>
    </section>
    <section className="container py-16 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        <p className="text-lg text-foreground/80 leading-relaxed">
          AMAKA'S CITY ist ein erstklassiges Massagestudio mit afrikanischen Wurzeln in Essen.
        ...
        <h3 className="font-serif text-2xl text-primary-deep mt-8">Warum AMAKA'S CITY?</h3>
