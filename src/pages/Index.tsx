    ...
    <Layout>
        ...
        <div className="container grid lg:grid-cols-2 gap-10 items-center py-16 lg:py-24">
          <div>
            ...
            <p className="text-base md:text-lg text-foreground/70 mt-6 max-w-md">
              Professional massage in a calm and private environment.
              Take time for your body and mind.
            </p>
          ...
          <div className="relative">
            <img
              src={hero}
              alt="Professional massage therapist in Essen"
              width={1536}
              height={1024}
            ...
            <div className="absolute -bottom-6 -left-6 hidden md:flex items-center gap-3 bg-background rounded-2xl shadow-soft p-4">
              ...
              <div>
                <div className="font-serif text-primary-deep font-semibold">Premium Wellness</div>
                <div className="text-xs text-muted-foreground">in Essen since years</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container py-20">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="font-serif text-4xl text-primary-deep">About Us</h2>
          <p className="font-script text-2xl text-primary mt-2">Care, attention and experience.</p>
        </div>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <img src={interior} alt="Calm massage room interior" loading="lazy" width={1200} height={800}
            className="rounded-2xl shadow-soft object-cover h-[400px] w-full" />
          <div>
            <p className="text-foreground/80 leading-relaxed text-lg">
              At Amaka Massage, your well-being comes first. Every treatment is done with
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <Flower2 className="h-8 w-8 text-primary mx-auto mb-2" />
            <h2 className="font-serif text-4xl text-primary-deep">Our Services</h2>
            <p className="text-muted-foreground mt-2">Professional care for your body and mind.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
              <article key={s.name} className="bg-card rounded-2xl overflow-hidden shadow-card hover:shadow-soft transition-shadow group">
      ...
      <section className="gradient-purple text-primary-foreground py-20">
        <div className="container text-center">
          <h2 className="font-serif text-4xl md:text-5xl">Take care of your body.</h2>
